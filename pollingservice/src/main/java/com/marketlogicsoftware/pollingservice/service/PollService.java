package com.marketlogicsoftware.pollingservice.service;

import com.marketlogicsoftware.pollingservice.model.*;
import com.marketlogicsoftware.pollingservice.payload.PagedResponse;
import com.marketlogicsoftware.pollingservice.payload.PollRequest;
import com.marketlogicsoftware.pollingservice.payload.PollResponse;
import com.marketlogicsoftware.pollingservice.util.AppConstants;
import com.marketlogicsoftware.pollingservice.util.ModelMapper;
import com.marketlogicsoftware.pollingservice.exception.BadRequestException;
import com.marketlogicsoftware.pollingservice.exception.ResourceNotFoundException;
import com.marketlogicsoftware.pollingservice.payload.VoteRequest;
...
public class PollService {
    ...
    public PollResponse castVoteAndGetUpdatedPoll(Long pollId, VoteRequest voteRequest, UserPrincipal currentUser) {
        ...
        Choice selectedChoice = poll.getChoices().stream()
                .filter(choice -> choice.getId().equals(Long.valueOf(voteRequest.getChoiceId())))
                .findFirst()
